        ...
        <div className="min-h-screen bg-white pb-24 px-6 pt-10">
            <div className="max-w-xl mx-auto">
                <div className="flex items-center justify-between mb-8">
                    <h1 className="text-2xl font-black text-gray-900 tracking-tight">Electronic Wallet</h1>
                ...
                <motion.div
                    ...
                    className="bg-blue-600 rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-2xl shadow-blue-200 mb-8"
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex gap-4 mt-10">
                            <button className="flex-1 bg-white text-blue-600 font-bold py-3.5 rounded-2xl flex items-center justify-center gap-2 shadow-lg hover:scale-[1.02] transition-transform">
                                <Plus className="w-5 h-5" /> Top Up
                            </button>
                            <button className="flex-1 bg-blue-500 text-white font-bold py-3.5 rounded-2xl flex items-center justify-center gap-2 border border-blue-400/30 hover:bg-blue-500/80 transition-all">
                ...
                <div className="grid grid-cols-2 gap-4 mb-10">
                    <div className="p-5 bg-gray-50 rounded-[2rem] border border-gray-100 group hover:border-blue-200 cursor-pointer transition-all">
                        ...
                        <p className="text-[10px] text-gray-400 font-medium">Manage 2 cards</p>
                    </div>
                    <div className="p-5 bg-gray-50 rounded-[2rem] border border-gray-100 group hover:border-blue-200 cursor-pointer transition-all">
                        <div className="w-10 h-10 rounded-xl bg-white shadow-sm flex items-center justify-center text-blue-600 mb-3 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                        ...
                        <p className="text-[10px] text-gray-400 font-medium">View analytics</p>
                    </div>
                </div>
                    ...
                    <div className="space-y-3">
                        {transactions.map((t) => (
                            <motion.div
                                key={t.id}
                                whileHover={{ x: 4 }}
                                className="flex items-center gap-4 p-4 rounded-3xl hover:bg-gray-50 transition-all cursor-pointer border border-transparent hover:border-gray-100"
                            >
